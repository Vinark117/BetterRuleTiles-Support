...
namespace VinToolsEditor.BetterRuleTiles
{
    public class BetterRuleTileGenerator
    {
        ...
        static void SetVariations(BetterRuleTileContainer container, List<BetterRuleTile> tiles)
        {
            ...
            for (int i = 0; i < tiles.Count; i++)
            {
                ...
                foreach (var item in variations)
                {
                    ...
                    AddParentRules(ref obj.m_ExtendedTilingRules, tiles[i].m_ExtendedTilingRules);
        ...
        static void AddParentRules(ref List<ExtendedTilingRule> tileRules, List<ExtendedTilingRule> parentRules)
        {
